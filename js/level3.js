...
create: function() {
    ...
    var border = platforms.create(330, 30, 'paddle-vert');
    border.body.immovable = true;
    border.scale.setTo(1, 1);

    border = platforms.create(130, 30, 'paddle-vert');
    border.body.immovable = true;
    border.scale.setTo(1, 1);
                    /*кнопка старт*/ 
    ...
    this.initBricks();
                   /*счёт игры*/ 
    scoreText = this.add.text(15, 7, 'Level 3', { font: '15px Arial', fill: 'white' });
                   /*счёт попыток*/ 
